    ...
    <body>
        ...
        <table border="1" cellspacing="10" style="background-color: azure;alignment-adjust: central;text-align: center;margin-top: 100px;margin-left: 0px;">
            ...
            <% 
                ...
                ResultSet res;
                DBconnect.connect();
                res=DBconnect.fetchdata("select * from eventdb where manager='"+session.getAttribute("username")+"'");
                while(res.next()) {
            ...
            %>    
                ...
                <tr> 
                    <td>  <% 
                            out.println(res.getString("eventname"));
                            events.add(res.getString("eventname"));
                          %> 
                    </td>
                    ...
                    <td>  
                    <a href="Participant.jsp"><input type="submit" value="View Participant" name=countSubmit /> 
                        <%session.setAttribute("eventname",events.get(0));%>
                    </a>
                    </td>
                    <td>  
                    <a href="volunteer.jsp"><input type="submit" value="View Volunteer" name=countSubmit /> 
                        <%session.setAttribute("eventname",events.get(0));%>
                    </a> 
                    </td>
