    ...
    <body>
        ...
        <table border="1" cellspacing="10" style="background-color: azure;alignment-adjust: central;text-align: center;margin-top: 100px;margin-left: 0px;">
            ...
            <% 
                ...
                ResultSet res;
                DBconnect.connect();
                res=DBconnect.fetchdata("select * from volunteer where manager='"+session.getAttribute("username")+"' and eventname='"+session.getAttribute("eventname")+"'");
                while(res.next()){
            %>    
                <tr> 
                    <td>  <% out.println(res.getString("PID"));%> </td>
                    <td>  <% out.println(res.getString("volunteer")); %> </td>
                </tr>
